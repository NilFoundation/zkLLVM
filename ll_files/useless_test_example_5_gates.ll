; ModuleID = '/root/cblpok/zkllvm/zkllvm/examples/useless_test_example_5_gates.cpp'
source_filename = "/root/cblpok/zkllvm/zkllvm/examples/useless_test_example_5_gates.cpp"
...
for.cond.cleanup:                                 ; preds = %for.inc
  %a_pallas_base.addr.014.lcssa = phi __zkllvm_field_pallas_base [ %a_pallas_base.addr.014, %for.inc ]
  %add.le = add __zkllvm_field_pallas_base %a_pallas_base.addr.014.lcssa, %b_pallas_base
...
for.body:                                         ; preds = %entry, %for.inc
  ...
  %a_pallas_base.addr.014 = phi __zkllvm_field_pallas_base [ %a_pallas_base, %entry ], [ %mul, %for.inc ]
  %a_25519_field.addr.013 = phi __zkllvm_field_curve25519_base [ %a_25519_field, %entry ], [ %sub2, %for.inc ]
  %add = add __zkllvm_field_pallas_base %a_pallas_base.addr.014, %b_pallas_base
  %sub = sub __zkllvm_field_pallas_base %add, %b_pallas_base
  %mul = mul __zkllvm_field_pallas_base %sub, %b_pallas_base
  %add1 = add __zkllvm_field_curve25519_base %a_25519_field.addr.013, %b_25519_field
...
for.end:                                          ; preds = %for.cond.cleanup
  %add3 = add __zkllvm_field_pallas_base %mul.le, %b_pallas_base

; ModuleID = '/root/cblpok/zkllvm/zkllvm/examples/useless_test_example_3_gates.cpp'
source_filename = "/root/cblpok/zkllvm/zkllvm/examples/useless_test_example_3_gates.cpp"
...
for.cond.cleanup:                                 ; preds = %for.inc
  %a_pallas_base.addr.09.lcssa = phi __zkllvm_field_pallas_base [ %a_pallas_base.addr.09, %for.inc ]
  %add.le = add __zkllvm_field_pallas_base %a_pallas_base.addr.09.lcssa, %b_pallas_base
...
for.body:                                         ; preds = %entry, %for.inc
  %i.010 = phi i32 [ 0, %entry ], [ %inc, %for.inc ]
  %a_pallas_base.addr.09 = phi __zkllvm_field_pallas_base [ %a_pallas_base, %entry ], [ %mul, %for.inc ]
  %add = add __zkllvm_field_pallas_base %a_pallas_base.addr.09, %b_pallas_base
...
for.end:                                          ; preds = %for.cond.cleanup
  %add1 = add __zkllvm_field_pallas_base %mul.le, %b_pallas_base
  ret __zkllvm_field_pallas_base %add1
}

; ModuleID = '/root/cblpok/zkllvm/zkllvm/examples/useless_test_example_6_gates.cpp'
source_filename = "/root/cblpok/zkllvm/zkllvm/examples/useless_test_example_6_gates.cpp"
...
for.cond.cleanup:                                 ; preds = %for.inc
  %a_pallas_base.addr.017.lcssa = phi __zkllvm_field_pallas_base [ %a_pallas_base.addr.017, %for.inc ]
  %add.le = add __zkllvm_field_pallas_base %a_pallas_base.addr.017.lcssa, %b_pallas_base
...
for.body:                                         ; preds = %entry, %for.inc
  %i.018 = phi i32 [ 0, %entry ], [ %inc, %for.inc ]
  %a_pallas_base.addr.017 = phi __zkllvm_field_pallas_base [ %a_pallas_base, %entry ], [ %mul, %for.inc ]
  %a_25519_field.addr.016 = phi __zkllvm_field_curve25519_base [ %a_25519_field, %entry ], [ %mul3, %for.inc ]
  %add = add __zkllvm_field_pallas_base %a_pallas_base.addr.017, %b_pallas_base
  %sub = sub __zkllvm_field_pallas_base %add, %b_pallas_base
  %mul = mul __zkllvm_field_pallas_base %sub, %b_pallas_base
  %add1 = add __zkllvm_field_curve25519_base %a_25519_field.addr.016, %b_25519_field

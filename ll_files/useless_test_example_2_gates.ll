; ModuleID = '/root/cblpok/zkllvm/zkllvm/examples/useless_test_example_2_gates.cpp'
source_filename = "/root/cblpok/zkllvm/zkllvm/examples/useless_test_example_2_gates.cpp"
...
for.cond.cleanup:                                 ; preds = %for.inc
  %a_pallas_base.addr.07.lcssa = phi __zkllvm_field_pallas_base [ %a_pallas_base.addr.07, %for.inc ]
  %add.le = add __zkllvm_field_pallas_base %a_pallas_base.addr.07.lcssa, %b_pallas_base
  %sub.le = sub __zkllvm_field_pallas_base %add.le, %b_pallas_base
  br label %for.end

for.body:                                         ; preds = %entry, %for.inc
  %i.08 = phi i32 [ 0, %entry ], [ %inc, %for.inc ]
  %a_pallas_base.addr.07 = phi __zkllvm_field_pallas_base [ %a_pallas_base, %entry ], [ %sub, %for.inc ]
  %add = add __zkllvm_field_pallas_base %a_pallas_base.addr.07, %b_pallas_base
...
for.end:                                          ; preds = %for.cond.cleanup
  %add1 = add __zkllvm_field_pallas_base %sub.le, %b_pallas_base

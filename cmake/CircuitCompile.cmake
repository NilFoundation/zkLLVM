...
set(CIRCUIT_DEPENDENCIES  crypto3::algebra
                          crypto3::block
                          crypto3::blueprint
                          crypto3::codec
                          crypto3::math
...
function(add_circuit name)
    ...
    add_custom_command(OUTPUT ${binary_name}
                       ...
                       COMMAND $<TARGET_FILE:clang> -DZKLLVM_INLINES_ENABLED ${INCLUDE_DIRS_LIST} -emit-llvm -S -O1 -std=c++20 -o ${binary_name} ${ARG_SOURCE}

...
function(add_circuit)
    ...
    if (ZKLLVM_DEV_ENVIRONMENT)
        ...
        set(LINKER llvm-link-zkllvm)
        set(libc_stdlib "${CMAKE_INSTALL_PREFIX}/lib/zkllvm/lib/zkllvm/zkllvm-libc.ll")
        set(libcpp_stdlib "${CMAKE_INSTALL_PREFIX}/lib/zkllvm/lib/zkllvm/zkllvm-libcpp.ll")
    endif()
    if (NOT ${CIRCUIT_BINARY_OUTPUT})
        set(link_options "-S")
    endif()

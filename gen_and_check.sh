...
#ninja -C build merkle_tree_poseidon_cpp_example_assign -j10
...
#ninja -C build integer_arithmetics_cpp_example_assign -j10
...
#ninja -C build balance_cpp_example_assign -j10
...
#ninja -C build poseidon_cpp_example_assign -j10
...
#ninja -C build pallas_curve_addition_cpp_example_assign -j10
...
#ninja -C build polynomial_cpp_example_assign -j10
...
#ninja -C build_recursive placeholder_verifier_cpp_example -j4

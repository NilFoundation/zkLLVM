...
#define ARRAY_SUM_1(arr) arr[0]
#define ARRAY_SCALAR_MUL_1(arr1, arr2) arr1[0]*arr2[0]

constexpr std::size_t lookup_gate_size = 1;
constexpr std::size_t lookup_table_size = 1;


constexpr std::array<std::size_t, lookup_table_size> lookup_table_lookup_options_sizes = {1};
constexpr std::array<std::size_t, lookup_table_size> lookup_table_columns_numbers = {3};
constexpr std::size_t lookup_options_size = ARRAY_SUM_1(lookup_table_lookup_options_sizes);
constexpr std::size_t lookup_value_columns_size = ARRAY_SCALAR_MUL_1(lookup_table_lookup_options_sizes, lookup_table_columns_numbers);

constexpr std::array<std::size_t, lookup_gate_size> lookup_gate_constraints_sizes = {1};
constexpr std::size_t lookup_constraints_size = ARRAY_SUM_1(lookup_gate_constraints_sizes);
constexpr std::array<std::size_t, lookup_constraints_size> lookup_gate_constraints_lookup_input_sizes = {3};
constexpr std::size_t lookup_input_columns_size = ARRAY_SUM_1(lookup_gate_constraints_lookup_input_sizes);

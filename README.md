...
${ZKLLVM_BUILD:-build}/bin/assigner/assigner -b ${ZKLLVM_BUILD:-build}/examples/arithmetics_example.ll -i examples/arithmetics.inp -t assignment.tbl -c circuit.crct -e 0
```

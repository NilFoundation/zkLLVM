...
typename pallas::base_field_type::value_type evaluate_root(typename pallas::base_field_type::value_type a,
...
[[circuit]] bool merkle_tree_poseidon(typename pallas::base_field_type::value_type expected_root,
                                      [[private_input]] std::array<typename pallas::base_field_type::value_type, 64>
                                          inp) {

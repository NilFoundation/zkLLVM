...
bool check_root(typename pallas::base_field_type::value_type expected_root,
                [[private_input]] std::array<typename pallas::base_field_type::value_type, 0x20>
                    layer_0_leaves) {
    ...
    typename pallas::base_field_type::value_type real_root =
        hash<hashes::poseidon>(layer_4_leaves[0], layer_4_leaves[1]);
...
[[circuit]] bool merkle_tree_poseidon(typename pallas::base_field_type::value_type expected_root1,
                                      [[private_input]] std::array<typename pallas::base_field_type::value_type, 0x20>
                                          layer_0_leaves1,

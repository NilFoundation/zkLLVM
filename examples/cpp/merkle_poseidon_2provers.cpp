...
[[circuit]] bool merkle_tree_poseidon (
    ...
    [[private_input]] std::array<typename pallas::base_field_type::value_type, 0x20> layer_0_leaves1,
    typename pallas::base_field_type::value_type expected_root2,
    [[private_input]] std::array<typename pallas::base_field_type::value_type, 0x20> layer_0_leaves2
) {

...
typename pallas::base_field_type::value_type
    evaluate_root([[private_input]] std::array<typename pallas::base_field_type::value_type, 0x2> layer_0_leaves) {
...
[[circuit]] bool merkle_tree_poseidon(typename pallas::base_field_type::value_type expected_root,
                                      [[private_input]] std::array<typename pallas::base_field_type::value_type, 0x2>
                                          layer_0_leaves1,
                                      [[private_input]] std::array<typename pallas::base_field_type::value_type, 0x2>
                                          layer_0_leaves2) {

...
constexpr std::size_t m_parameter = lookup_table_size + lookup_gate_size;

constexpr std::array<std::size_t, lookup_table_size> lookup_table_lookup_options_sizes = {1,2,3};
constexpr std::array<std::size_t, lookup_table_size> lookup_table_columns_numbers = {1,2,3};
constexpr std::array<std::size_t, lookup_gate_size> lookup_gate_constraints_sizes = {1,2,3};
constexpr std::array<std::size_t, lookup_gate_size> lookup_gate_constraints_lookup_input_sizes = {1,2,3};
...
constexpr std::size_t input_size_lookup_gate_constraints_table_ids = ARRAY_SUM_3(lookup_gate_constraints_sizes);
constexpr std::size_t input_size_lookup_gate_constraints_lookup_inputs = ARRAY_SUM_3(lookup_gate_constraints_lookup_input_sizes);

constexpr std::size_t input_size_lookup_table_selectors = lookup_table_size;
constexpr std::size_t input_size_lookup_table_lookup_options = ARRAY_SCALAR_MUL_3(lookup_table_lookup_options_sizes, lookup_table_columns_numbers);

constexpr std::size_t input_size_shifted_lookup_table_selectors = lookup_table_size;
constexpr std::size_t input_size_shifted_lookup_table_lookup_options = input_size_lookup_table_lookup_options;
...
[[circuit]] output_type
    ...
    std::array<typename pallas::base_field_type::value_type, input_size_lookup_gate_constraints_table_ids> lookup_gate_constraints_table_ids,
    std::array<typename pallas::base_field_type::value_type, input_size_lookup_gate_constraints_lookup_inputs> lookup_gate_constraints_lookup_inputs,
    ...
    return __builtin_assigner_lookup_arg_verifier(
        (int*)lookup_table_lookup_options_sizes.data(),
        (int*)lookup_table_columns_numbers.data(),
        lookup_table_size,
        (int*)lookup_gate_constraints_sizes.data(),
        (int*)lookup_gate_constraints_lookup_input_sizes.data(),
        lookup_gate_size,
        ...
        lookup_table_selectors.data(), input_size_lookup_table_selectors,
        lookup_table_lookup_options.data(), input_size_lookup_table_lookup_options,
        shifted_lookup_table_selectors.data(), input_size_shifted_lookup_table_selectors,
        shifted_lookup_table_lookup_options.data(), input_size_shifted_lookup_table_lookup_options,
        sorted.data(), input_size_sorted,
        theta, beta, gamma, L0,
...
lookup_table_lookup_options_sizes, lookup_table_columns_numbers, lookup_gate_constraints_sizes, lookup_gate_constraints_lookup_input_sizes
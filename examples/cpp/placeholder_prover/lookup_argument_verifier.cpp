...
constexpr std::size_t lookup_value_columns_size = ARRAY_SCALAR_MUL_4(lookup_table_lookup_options_sizes, lookup_table_columns_numbers);
...
constexpr std::array<std::size_t, lookup_constraints_size> lookup_gate_constraints_lookup_input_sizes = {2,1,1,3,2,1};
